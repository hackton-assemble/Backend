package assemble.eolmangyo.global.common.response;
...
public enum BaseResponseStatus {
	...
	// Pet
	NO_EXIST_PET_CATEGORY(HttpStatus.NOT_FOUND, false, 2401, "존재하지 않는 펫 카테고리입니다."),

	// Interest
	NO_EXIST_INTEREST(HttpStatus.NOT_FOUND, false, 2501, "존재하지 않는 관심사입니다."),

	// follower
	NOT_FOLLOW_SELF(HttpStatus.BAD_REQUEST, false, 2601, "본인을 팔로우할 수 없습니다"),

	/**
	 * 3000: shorts service error
	 */

	// Shorts
	NO_EXIST_MUSIC(HttpStatus.NOT_FOUND, false, 3001, "존재하지 않는 음악입니다"),
	NO_EXIST_SHORTS(HttpStatus.NOT_FOUND, false, 3002, "존재하지 않는 글입니다"),
	INVALID_SHORTS_TYPE(HttpStatus.BAD_REQUEST, false, 3003, "잘못된 글 조회 타입입니다"),
	NO_EXIST_MUSIC_TAG(HttpStatus.BAD_REQUEST, false, 3004, "존재하지 않는 음악 태그입니다"),
